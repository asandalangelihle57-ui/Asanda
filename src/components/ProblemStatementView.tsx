...
export const ProblemStatementView: React.FC<ProblemStatementViewProps> = ({
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 animate-fadeIn">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-900 to-rose-950/40 border border-slate-800 rounded-xl p-5 sm:p-6 shadow-xl relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 relative z-10">
          <div>
            <div className="flex items-center gap-2.5 flex-wrap">
              <span className="bg-rose-500/20 text-rose-300 border border-rose-500/30 text-xs px-2.5 py-0.5 rounded-full font-bold flex items-center gap-1.5 uppercase tracking-wider">
                <ShieldAlert className="w-3.5 h-3.5 text-rose-400" />
                Statutory Deficiencies Control
              </span>
              <span className="bg-slate-800 text-slate-300 text-xs px-2.5 py-0.5 rounded-full border border-slate-700">
                PFMA Act 1 of 1999 • National Treasury Regulations
              </span>
            </div>
            <h2 className="text-xl sm:text-2xl font-black text-white tracking-tight mt-2">
              Problems Listed on Official DSAC Statement
            </h2>
            <p className="text-xs sm:text-sm text-slate-400 max-w-3xl mt-1.5 leading-relaxed">
              Direct diagnostic monitoring and corrective action execution for the <strong>7 core statutory challenges</strong> identified in the Department of Sport, Arts and Culture (DSAC) public entities oversight statement.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0">
            <button
              ...
              className="bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 hover:border-slate-600 px-3.5 py-2 rounded-lg text-xs font-semibold flex items-center gap-2 transition-colors shadow"
            ...
            <button
              ...
              className="bg-emerald-600 hover:bg-emerald-500 text-white px-3.5 py-2 rounded-lg text-xs font-semibold flex items-center gap-2 transition-colors shadow"
            >
              <Scale className="w-4 h-4" />
              View AGSA Audit Findings
            </button>
          </div>
        </div>

        {/* High-Level Diagnostic Metric Cards */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6 pt-5 border-t border-slate-800/80">
          <div className="bg-slate-950/60 border border-slate-800 rounded-lg p-3">
            <div className="text-[11px] text-slate-400 font-medium flex items-center justify-between">
              <span>Statement Issues</span>
              <FileText className="w-3.5 h-3.5 text-slate-400" />
            </div>
            <div className="text-2xl font-black text-white mt-1">{totalCount}</div>
            <div className="text-[10px] text-slate-400 mt-0.5">Codified statutory challenges</div>
          </div>
          ...
          <div className="bg-slate-950/60 border border-rose-900/40 rounded-lg p-3">
            ...
            <div className="text-[10px] text-rose-300/80 mt-0.5">UIFW, AGSA & Reporting integrity</div>
          </div>
          ...
          <div className="bg-slate-950/60 border border-amber-900/40 rounded-lg p-3">
            ...
            <div className="text-2xl font-black text-amber-400 mt-1">{actionRequiredCount}</div>
            <div className="text-[10px] text-amber-300/80 mt-0.5">Submissions & evidence gap</div>
          </div>
          ...
          <div className="bg-slate-950/60 border border-emerald-900/40 rounded-lg p-3">
            ...
            <div className="text-2xl font-black text-emerald-400 mt-1">{avgProgress}%</div>
            <div className="text-[10px] text-emerald-300/80 mt-0.5">Milestones signed off</div>
          </div>
        </div>
      </div>

      {/* Filter and Search Bar */}
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex flex-wrap items-center justify-between gap-3 shadow">
        ...
        <div className="text-xs text-slate-400 font-medium">
          Showing <strong className="text-white">{filteredProblems.length}</strong> of {problems.length} Problem Statements
        </div>
      </div>
