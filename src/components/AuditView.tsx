    ...
    <div className="p-4 sm:p-6 space-y-6 animate-fadeIn">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-md flex flex-wrap items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-white tracking-tight">
              Auditor-General (AGSA) Audit Findings & Remediation Tracker
            </h2>
          </div>
          <p className="text-xs text-slate-400 mt-1">
            PFMA statutory audit observations, material irregularities, and corrective action plan milestones
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            Export AGSA Register (CSV)
          </button>
          <button
            onClick={() => setShowCreateModal(true)}
            className="flex items-center gap-1.5 px-3.5 py-1.5 bg-rose-600 hover:bg-rose-500 text-white rounded-lg text-xs font-bold shadow transition-all"
          >
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 shadow-md flex flex-wrap items-center justify-between gap-3 text-xs">
        ...
        <span className="text-slate-400 font-mono">
          Displaying {filteredAudits.length} Audit Findings
        </span>
      </div>
